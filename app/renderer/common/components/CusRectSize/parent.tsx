...
import LeftComponent from "@common/components/CusRectSize/left";
import RightComponent from "@common/components/CusRectSize/right";
...
class ParentComponent extends React.Component<IProps>{
    ...
    render(){
        ...
        return (
            <div className="parent-box" style={{
                ...finialStyle, ...style
            }}>
                {this.getChild()}
            </div>
